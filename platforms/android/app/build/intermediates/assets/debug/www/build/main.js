...
var RideLaterPage = /** @class */ (function () {
    ...
    RideLaterPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-ride-later',template:/*ion-inline-start:"E:\Clients\Michael_Quinn\transportAppwithDelivery-master\src\pages\ride-later\ride-later.html"*/'<!--\n  Generated template for the RideLaterPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <ion-navbar>\n    <ion-title>Ride Later</ion-title>\n  </ion-navbar>  \n</ion-header>\n\n<ion-content overflow-scroll="true">\n    <div>\n      <ion-grid padding class="srcpt">\n        <ion-row class="addr_row">\n          <ion-col col-1 >\n            <ion-icon class="nav_icon" name="navigate"></ion-icon>\n          </ion-col>\n          <ion-col col-9 class="addr">\n            {{pick_up}}    \n          </ion-col>\n        </ion-row>\n      </ion-grid>\n        \n      <ion-grid padding class="srcpt">\n        <ion-row class="addr_row">\n          <ion-col col-1 >\n            <ion-icon name="pin"></ion-icon>\n          </ion-col>\n          <ion-col col-9 class="addr">\n            {{drop}}\n          </ion-col>\n        </ion-row>\n      </ion-grid>\n  \n      <ion-grid padding class="srcpt">\n        <ion-row class="addr_row">\n          <ion-col col-1 >\n            <ion-icon name="car"></ion-icon>    \n          </ion-col>\n          <ion-col col-9 class="addr">\n            {{vehicle_type}}\n          </ion-col>\n        </ion-row>\n      </ion-grid>\n  \n      <ion-grid padding class="moreInfo">\n        <ion-row>\n          <ion-col col-3 class="title_col">\n            Distance :\n          </ion-col>\n          <ion-col col-3 class="value_col">\n            {{distance}} \n          </ion-col>\n          <ion-col col-3 class="title_col">\n            Cost : \n          </ion-col>\n          <ion-col col-3 class="value_col">\n            ${{cost}}\n          </ion-col>\n        </ion-row> \n      </ion-grid>\n  \n      <ion-grid class="warnMessage">\n        <ion-row>\n          <ion-col>\n            <span text-center wrap-word>\n              Driver information will be send to you 5 minutes before ride begins.\n            </span>\n          </ion-col>\n        </ion-row>\n      </ion-grid>\n  \n      <div class="paymentMethodDiv">\n         <!--<img src={{vehicle_img}} />-->\n        <ion-grid>\n          <ion-row>\n            <ion-col col-4>\n              <div class="innerDiv" [ngClass]="active === \'cash\' ? \'active_payment\' : \'\'" (click)="updateActive(\'cash\')">\n                <img class="list_item_icon" src="assets/imgs/notes.png"/>\n                <ion-label>Cash</ion-label>\n              </div>\n            </ion-col>\n            <ion-col col-4>\n              <div class="innerDiv" [ngClass]="active === \'card\' ? \'active_payment\' : \'\'" (click)="updateActive(\'card\')">\n                <img class="list_item_icon" src="assets/imgs/credit-card.png"/>\n                <ion-label>Card</ion-label>\n              </div>\n            </ion-col>\n            <ion-col col-4>\n              <div class="innerDiv" [ngClass]="active === \'wallet\' ? \'active_payment\' : \'\'" (click)="updateActive(\'wallet\')">\n                <img class="list_item_icon" src="assets/imgs/wallet.png"/>\n                <ion-label>Wallet</ion-label>\n              </div>\n            </ion-col>\n          </ion-row>\n        </ion-grid>\n      </div>\n    </div>\n    <!-- <button (click)=\'showAlert()\' class="login-btn" ion-button color="primary" block  [disabled]="!isnowenabled">Confirm Ride Request</button> -->\n  </ion-content>\n  <!-- <ion-footer>\n    \n  </ion-footer> -->\n  <ion-footer class="cust-btn-div">\n    <!-- <ion-toolbar>\n      <ion-title>Footer</ion-title>\n    </ion-toolbar> -->\n    <button (click)=\'showAlert()\' ion-button color="primary" block  [disabled]="!isnowenabled">Confirm Ride Request</button>\n  </ion-footer>\n \n'/*ion-inline-end:"E:\Clients\Michael_Quinn\transportAppwithDelivery-master\src\pages\ride-later\ride-later.html"*/,
        }),
...
var DriversettingPage = /** @class */ (function () {
    ...
    DriversettingPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-driversetting',template:/*ion-inline-start:"E:\Clients\Michael_Quinn\transportAppwithDelivery-master\src\pages\driversetting\driversetting.html"*/'<!--\n  Generated template for the DriversettingPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n      <button ion-button menuToggle >\n          <ion-icon ios="ios-list" md="md-list" class="ion-md-list"></ion-icon>\n      </button>\n    <ion-title>Settings</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n  <ion-item>\n    <ion-label>Visible to customers</ion-label>\n    <ion-toggle [(ngModel)]="isToggled" (ionChange)="notify()"></ion-toggle>\n  </ion-item>\n\n  <ion-item>\n    <ion-label>Silent Notifications</ion-label>\n    <ion-toggle [(ngModel)]="isNotificationOff" (ionChange)="notificationOff()"></ion-toggle>\n  </ion-item>\n</ion-content> \n '/*ion-inline-end:"E:\Clients\Michael_Quinn\transportAppwithDelivery-master\src\pages\driversetting\driversetting.html"*/,
        }),
...
var UploadProfilePage = /** @class */ (function () {
    ...
    UploadProfilePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-upload-profile',template:/*ion-inline-start:"E:\Clients\Michael_Quinn\transportAppwithDelivery-master\src\pages\upload-profile\upload-profile.html"*/'<!--\n  Generated template for the UploadProfilePage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <ion-navbar>\n    <ion-title>Upload Profile</ion-title>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content padding>\n  <img src="{{imgPreview}}">\n  <h3 >Please Select Image!</h3>\n  <!--<img src="{{pathForImage(lastImage)}}" style="width: 100%" [hidden]="lastImage === null">\n  <h3 [hidden]="lastImage !== null">Please Select Image!</h3>\n</ion-content>-->\n       \n<ion-footer>\n      <ion-grid>\n        <ion-row>\n          <ion-col col-6>\n            <button ion-button icon-left (click)="presentActionSheet()">\n              <ion-icon name="camera"></ion-icon>Select Image\n            </button>\n          </ion-col>\n          <ion-col col-6>          \n            <button ion-button icon-left (click)="uploadImage()" >\n              <ion-icon name="cloud-upload"></ion-icon>Upload\n            </button>\n          </ion-col>\n        </ion-row>\n      </ion-grid>\n</ion-footer>'/*ion-inline-end:"E:\Clients\Michael_Quinn\transportAppwithDelivery-master\src\pages\upload-profile\upload-profile.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_74__pages_modalpage_modalpage_module__ = __webpack_require__(230);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_82__pages_notifications_notifications_module__ = __webpack_require__(229);
